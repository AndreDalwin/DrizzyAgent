...
export const GitMasterConfigSchema = z.object({
  /** Add the default DrizzyAgent footer to commit messages (default: true). Can be boolean or custom string. */
  commit_footer: z.union([z.boolean(), z.string()]).default(true),
  /** Add the default DrizzyBot co-author trailer to commit messages (default: true) */
