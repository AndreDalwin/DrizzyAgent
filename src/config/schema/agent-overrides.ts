...
export const AgentOverridesSchema = z.object({
  ...
  gptcoder: AgentOverrideConfigSchema.extend({
    allow_non_gpt_model: z.boolean().optional(),
  }).optional(),
  "coder-junior": AgentOverrideConfigSchema.optional(),
  "OpenCode-Builder": AgentOverrideConfigSchema.optional(),
  planner: AgentOverrideConfigSchema.optional(),
  planConsultant: AgentOverrideConfigSchema.optional(),
  planReviewer: AgentOverrideConfigSchema.optional(),
