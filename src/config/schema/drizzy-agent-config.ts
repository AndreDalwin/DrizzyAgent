...
import { CoderConfigSchema } from "./coder"
import { CoderAgentConfigSchema } from "./coder-agent"
import { TmuxConfigSchema } from "./tmux"
import { StartWorkConfigSchema } from "./start-work"
import { WebsearchConfigSchema } from "./websearch"

export const DrizzyAgentConfigSchema = z.object({
  $schema: z.string().optional(),
  /** Enable new task system (default: false) */
  new_task_system_enabled: z.boolean().optional(),
  /** Default agent name for `drizzy-agent run` (env: OPENCODE_DEFAULT_AGENT) */
  ...
  coder_agent: CoderAgentConfigSchema.optional(),
