...
| `generate-drizzy-config.ts` | Generate `drizzy-agent.json` from install selections |
...
5. generate-drizzy-config (build config from user selections)
6. write-drizzy-config
