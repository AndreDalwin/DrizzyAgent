...
Common patterns: Claude/OpenAI/Gemini are preferred when an agent chain includes them, `librarian` prefers ZAI, `coder` falls back through Kimi then GLM-5, and `GPTCoder` requires OpenAI-compatible providers.
