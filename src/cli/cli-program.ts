...
program
  .name("drizzy-agent")
  .description("DrizzyAgent for OpenCode - multi-model orchestration, tools, and workflows")
  .version(VERSION, "-v, --version", "Show version number")
  .enablePositionalOptions()

program
  .command("install")
  .description("Install and configure DrizzyAgent with interactive setup")
...
program
  .command("doctor")
  .description("Check DrizzyAgent installation health and diagnose issues")
