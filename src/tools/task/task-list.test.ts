...
describe("createTaskList", () => {
  ...
  beforeEach(() => {
    taskDir = join(testProjectDir, ".drizzy/tasks")
  ...
  it("excludes completed tasks by default", async () => {
    ...
    writeJsonAtomic(join(testProjectDir, ".drizzy/tasks", "T-1.json"), task1)
  ...
  it("excludes deleted tasks by default", async () => {
   ...
   it("returns summary format with id, subject, status, owner, blockedBy", async () => {
    ...
    expect(summary.owner).toBe("coder")
  ...
  it("filters blockedBy to only include unresolved (non-completed) blockers", async () => {
    ...
    writeJsonAtomic(join(testProjectDir, ".drizzy/tasks", "T-blocker-completed.json"), blockerCompleted)
    writeJsonAtomic(join(testProjectDir, ".drizzy/tasks", "T-blocker-pending.json"), blockerPending)
