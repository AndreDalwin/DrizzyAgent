/** GPT-5.3 Codex optimized GPTCoder prompt */
...
/**
 * GPTCoder - The Autonomous Deep Worker
 *
...
export function createGptcoderAgent(
  ...
  const prompt = availableAgents
    ...
    : buildGptcoderPrompt([], tools, skills, categories, useTaskSystem);

  return {
    description:
      "Autonomous Deep Worker - goal-oriented execution with GPT 5.4 Codex. Explores thoroughly before acting, uses explore/librarian agents for comprehensive context, completes tasks end-to-end. Inspired by AmpCode deep mode. (GPTCoder - DrizzyAgent)",
    mode: MODE,
    model,
    maxTokens: 32000,
    prompt,
